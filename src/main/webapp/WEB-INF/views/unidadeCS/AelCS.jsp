...
function validar(){
	...
	<form name="aelCs" class="form-signin" action="/aelCs" method="post">
		...
		<!-- Botão responsável por enviar as informações atualizadas para o banco da unidade escolhida ou voltar para o arquivo home.jsp para escolher outra unidade-->
			<br>
