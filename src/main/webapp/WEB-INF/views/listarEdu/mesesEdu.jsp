...
<body>
	...
	<div class="w-25 p-3">
		<form name="meses" class="needs-validation" novalidate action="/pesquisapormeses"  method="post">
		...
		<!-- Unidade que deseja recuperar -->               
            ...
            <select class="custom-select d-block w-100" name="unidade" id="unidade" required>
              ...
              <option value="escola">ESCOLA SESI</option>
              <option value="jpg">JPG</option>
               <option value="jrf">JRF</option>
              <option value="jurc">JURC</option>
              <option value="pfa">PFA</option>
              <option value="museu">SESI MUSEU DIGITAL</option>
