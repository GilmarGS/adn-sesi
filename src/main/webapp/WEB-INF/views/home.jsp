...
<body id="page-top">
  ...
  <script type="text/javascript" src="resource/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for all pages-->
  <script type="text/javascript" src="resource/js/sb-admin-2.min.js"></script>

  <!-- Page level plugins -->
  <script type="text/javascript" src="resource/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script type="text/javascript" src="resource/js/demo/chart-area-demo.js"></script>
  <script type="text/javascript" src="resource/js/demo/chart-pie-demo.js"></script>
