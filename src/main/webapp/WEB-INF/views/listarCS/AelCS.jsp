...
<body>
    ...
    <table class="table table-bordered">          
        ...
        <tr>          
            <td colspan="4">${formael.metaHospedagem}</td>               	
            <td colspan="4">${formael.realizacaoHospedagem}</td>
        </tr>    
        <tr class="bg-primary">
        ...
        <tr>          
            <td colspan="4">${formael.metaClube}</td>               	
            <td colspan="4">${formael.realizacaoClube}</td>
        </tr>
        <tr class="br-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
