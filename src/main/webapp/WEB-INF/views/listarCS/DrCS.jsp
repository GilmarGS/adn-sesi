...
<body>
    ...
    <table class="table table-bordered">
        ...
        <tr>          
            <td colspan="4">${formdr.metaHospedagem}</td>               	
            <td colspan="4">${formdr.realizacaoHospedagem}</td>
        </tr>    
        <tr class="bg-primary">
        ...
        <tr>          
            <td colspan="4">${formdr.metaClube}</td>               	
            <td colspan="4">${formdr.realizacaoClube}</td>
        </tr>
        <tr class="br-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
