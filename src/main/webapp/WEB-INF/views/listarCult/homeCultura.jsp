...
<style>
 ...
 <% String anoAtual = new java.text.SimpleDateFormat("yyyy").format(new java.util.Date());%>
	...
	<div class="row">
  		<div class="col-sm-6">    		
      			<div class="card-body">
        			<a href="unidadescult/formDma" type="button" class="btn btn-primary btn-lg btn-block">Editar Planilhas</a>
      			</div>
      	</div>
  	<div class="col-sm-6">    	
      		<div class="card-body">
       			<a href="mesesCult" type="button" class="btn btn-primary btn-lg btn-block">Visualizar por mês</a>
      		</div>   	
  		</div>
  	</div>
	</div>
