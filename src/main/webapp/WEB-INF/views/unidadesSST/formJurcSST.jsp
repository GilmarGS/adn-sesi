...
<body><script type="text/javascript">
	...
	<div class="container">	
				...
				<div class="collapse navbar-collapse" id="navbarNavDropdown">
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link" href="/unidadessst/formJpg">JPG</a></li>
	...
	<form name="jurc" class="form-signin" action="/jurcSst" method="post">
		<div class="container">		  
			 ...
			 <button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="collapse" data-target="#realizacao">REALIZAÇÃO</button>
				...
				<label class="text-primary">SST</label><br>
						...
						<label>EXAMES OCUPACIONAIS</label>
						  <div class="form-row">
    						<div class="col">
      							<input type="text" name="realizacaoExamesOcup" class="form-control" placeholder="REALIZADO" autocomplete="off">
							</div>	
						</div>			
  					</div>
				</div>
