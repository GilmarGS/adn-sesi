...
<body>
    ...
    <table class="table table-bordered">
        ...
        <tr>          
           	<td colspan="4">${formjrf.metaPCMAT}</td>               	
           	<td colspan="4">${formjrf.realizacaoPCMAT}</td>         
        </tr>
        <tr class="bg-primary">
        ...
        <tr>          
           	<td colspan="4">${formjrf.metaPPRA}</td>               	
           	<td colspan="4">${formjrf.realizacaoPPRA}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formjrf.metaPPRAAmbiental}</td>               	
           	<td colspan="4">${formjrf.realizacaoPPRAAmbiental}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formjrf.metaErgonomia}</td>               	
           	<td colspan="4">${formjrf.realizacaoErgonomia}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formjrf.metaLTCAT}</td>               	
           	<td colspan="4">${formjrf.realizacaoLTCAT}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formjrf.metaPCMSO}</td>               	
           	<td colspan="4">${formjrf.realizacaoPCMSO}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formjrf.metaConsultasOE}</td>               	
           	<td colspan="4">${formjrf.realizacaoConsultasOE}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formjrf.metaExamesOcup}</td>               	
           	<td colspan="4">${formjrf.realizacaoExamesOcup}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
