...
<body>
    ...
    <table class="table table-bordered">
        ...
        <tr>          
           	<td colspan="4">${formjurc.metaPCMAT}</td>               	
           	<td colspan="4">${formjurc.realizacaoPCMAT}</td>         
        </tr>
        <tr class="bg-primary">
        ...
        <tr>          
           	<td colspan="4">${formjurc.metaPPRA}</td>               	
           	<td colspan="4">${formjurc.realizacaoPPRA}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formjurc.metaPPRAAmbiental}</td>               	
           	<td colspan="4">${formjurc.realizacaoPPRAAmbiental}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formjurc.metaErgonomia}</td>               	
           	<td colspan="4">${formjurc.realizacaoErgonomia}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formjurc.metaLTCAT}</td>               	
           	<td colspan="4">${formjurc.realizacaoLTCAT}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formjurc.metaPCMSO}</td>               	
           	<td colspan="4">${formjurc.realizacaoPCMSO}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formjurc.metaConsultasOE}</td>               	
           	<td colspan="4">${formjurc.realizacaoConsultasOE}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formjurc.metaExamesOcup}</td>               	
           	<td colspan="4">${formjurc.realizacaoExamesOcup}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
