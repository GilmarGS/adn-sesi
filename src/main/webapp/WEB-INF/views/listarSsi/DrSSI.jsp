...
<body>
    ...
    <table class="table table-bordered">
        ...
        <tr>          
           	<td colspan="4">${formdr.metaPCMAT}</td>               	
           	<td colspan="4">${formdr.realizacaoPCMAT}</td>         
        </tr>
        <tr class="bg-primary">
        ...
        <tr>          
           	<td colspan="4">${formdr.metaPPRA}</td>               	
           	<td colspan="4">${formdr.realizacaoPPRA}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formdr.metaPPRAAmbiental}</td>               	
           	<td colspan="4">${formdr.realizacaoPPRAAmbiental}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formdr.metaErgonomia}</td>               	
           	<td colspan="4">${formdr.realizacaoErgonomia}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formdr.metaLTCAT}</td>               	
           	<td colspan="4">${formdr.realizacaoLTCAT}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formdr.metaPCMSO}</td>               	
           	<td colspan="4">${formdr.realizacaoPCMSO}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formdr.metaConsultasOE}</td>               	
           	<td colspan="4">${formdr.realizacaoConsultasOE}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
        ...
        <tr>          
           	<td colspan="4">${formdr.metaExamesOcup}</td>               	
           	<td colspan="4">${formdr.realizacaoExamesOcup}</td>         
        </tr>
        <tr class="bg-primary">
        	<td colspan="4" align="center" id="cor">RECEITA DE SERVIÇO</td>
        	<td colspan="4" align="center" id="cor">DESPESAS</td>
