	...
	<div class="container">	
				...
				<div class="collapse navbar-collapse" id="navbarNavDropdown">
					<ul class="navbar-nav">
						...
						<li class="nav-item active"><a class="nav-link disable" href="#">AVS</a></li>						
		...
		<h3>ANÁLISE DE DESEMPENHO <%= anoAtual %> - AVS</h3><br>
	</div>
	<form name="avs" class="form-signin" action="/avsPs" method="post">
		<div class="container">		  
