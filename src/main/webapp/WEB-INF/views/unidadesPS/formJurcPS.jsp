	...
	<div class="container">	
				...
				<div class="collapse navbar-collapse" id="navbarNavDropdown">
					<ul class="navbar-nav">
						...
						<li class="nav-item active"><a class="nav-link disable" href="#">JURC</a></li>
					</ul>
				</div>
			</nav>
		<h3>ANÁLISE DE DESEMPENHO <%= anoAtual %> - JURC</h3><br>
	</div>
	<form name="jurc" class="form-signin" action="/jurcPs" method="post">
		<div class="container">		  
